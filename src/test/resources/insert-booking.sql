...
select setval('cars_id_seq', (select max(c.id) from cars c));
select setval('users_id_seq', (select max(c.id) from cars c));
select setval('bookings_id_seq', (select max(c.id) from cars c));